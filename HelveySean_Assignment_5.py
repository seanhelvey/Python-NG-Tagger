...
trainingFile = "/Users/seanhelvey/Desktop/HelveySean_Assignment_5/train.np"
developmentFile = "/Users/seanhelvey/Desktop/HelveySean_Assignment_5/dev.np"
    ...
    for sent in sents.list:
        if sent.score == sents.sentsMax and num == 0:
            ...
            for gram in sent.bigrams:
                ...
                outfile.write(str(gram.currentWord)+" "+ gram.currentTag + " " +str(checker(gram.correctNG)) + " " + str(x) + "\n")
